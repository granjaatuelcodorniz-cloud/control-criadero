  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-xl mx-auto px-4 py-6">
        ...
        {/* Tabs — solo owner ve los dos, colaboradora va directo */}
        {isOwner && (
        ...
        {(activeTab === 'consumo' || !isOwner) && (
          <form onSubmit={handleSubmitConsumo} className="space-y-4">
            ...
            <div className="card space-y-5">
              ...
              <Counter
                label="Bandejas de consumo"
                value={bandejas}
                onChange={setBandejas}
              />
              <Counter
                label="Bandejas de fértiles"
                sublabel="Recolectadas — el empaque lo completás vos"
                value={bandFertiles}
            ...
            <div className="card space-y-5">
              ...
              <Counter
                label="Docenas armadas"
                value={docenas}
                onChange={setDocenas}
              />
              <Counter
                label="Huevos rotos / descartados"
                sublabel="Unidades"
                value={rotos}
                onChange={setRotos}
              />
